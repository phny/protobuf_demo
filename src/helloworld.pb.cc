...
const uint32_t TableStruct_helloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::helloworld::helloworld, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::helloworld::helloworld, id_),
  PROTOBUF_FIELD_OFFSET(::helloworld::helloworld, str_),
  PROTOBUF_FIELD_OFFSET(::helloworld::helloworld, opt_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::helloworld::helloworld)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::helloworld::_helloworld_default_instance_._instance,
};
...
const ::_pbi::DescriptorTable descriptor_table_helloworld_2eproto = {
    false, false, 90, descriptor_table_protodef_helloworld_2eproto,
    "helloworld.proto",
...
helloworld::helloworld(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:helloworld.helloworld)
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "helloworld.helloworld.str"));
        } else
          goto handle_unusual;
        continue;
      // int32 opt = 3;
...
template<> PROTOBUF_NOINLINE ::helloworld::helloworld*
Arena::CreateMaybeMessage< ::helloworld::helloworld >(Arena* arena) {
  return Arena::CreateMessageInternal< ::helloworld::helloworld >(arena);
}
